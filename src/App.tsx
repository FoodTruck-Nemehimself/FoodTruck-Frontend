...
import { CustomerProtectedRoute, RestaurantProtectedRoute } from "./components/protectedRoutes/protectedRoute";
import OrderConfirmation from "./components/OrderConfirmation/OrderConfirmation";
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/menudetailspage" element={<MenuDetailsPage />} />
